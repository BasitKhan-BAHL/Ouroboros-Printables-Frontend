            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex justify-end gap-3 pt-4">
                ...
                <button
                  ...
                  className="rounded-lg bg-primary-900 px-6 py-2 font-secondary text-sm font-bold text-white hover:bg-primary-800 disabled:opacity-70 disabled:cursor-not-allowed transition-all"
                >
                  {isSubmitting ? (
                    <span className="flex items-center gap-2">
                      ...
                      {editingLicense ? "Updating..." : "Creating..."}
                    </span>
                  ) : (
